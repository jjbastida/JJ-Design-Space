...
function barMove() {
    if (barVal == 1) {
        ...
        setTimeout(function () {
            $(text).html("We as humans have a relationship with our oceans; the animals, micro-organisms, and plants that live in the oceans as well. Oil in our oceans is not a new occurrence; in fact, the majority of oil in our oceans seeps in naturally. But the added 36 million gallons of oil that enter due to human activity is impacting marine life in a new way. Although most finfish can detoxify many kinds of oils naturally, the increased amount makes it unlikely for them to process it and survive. In addition to that, most micro-organisms, shellfish, coral, birds, amphibians, reptiles, aquatic mammals and plants cannot process or defend against oil.");
        ...
        setTimeout(function () {
            text.innerHTML = "We as humans have a relationship with our oceans; the animals, micro-organisms, and plants that live in the oceans as well. Oil in our oceans is not a new occurrence; in fact, the majority of oil in our oceans seeps in naturally. But the added 36 million gallons of oil that enter due to human activity is impacting marine life in a new way. Although most finfish can detoxify many kinds of oils naturally, the increased amount makes it unlikely for them to process it and survive. In addition to that, most micro-organisms, shellfish, coral, birds, amphibians, reptiles, aquatic mammals and plants cannot process or defend against oil.";
            $(text).removeClass().addClass("bodyC");
            $(".secondMessage").css("display", "none")
        }, 800)
    }
        ...
        setTimeout(function () {
            text.innerHTML = "Coral however is a dying species. Shallow water fish, shellfish, amphibians, birds, and micro-organisms are being drastically affected by our pollution and oil spills.<br><br>Our oil spills are poisoning and killing ocean animals. In addition to that, a 2017 study found that coral enjoy eating plastic, like a junk food of sorts, but after eating and not being able to process it they break down and die, not knowing any better."
            $(text).removeClass().addClass("bodyC");
            $(".secondMessage").css("display", "none")
        }, 800)
    }
        ...
        setTimeout(function () {
            text.innerHTML = "Oil can be a deadly substance in our ocean, intoxicating marine life and in some cases blocking sunlight and nutrients from reaching plants and slowly leave an area to die. Coral and micro-organisms are less than safe from this, as many kinds of coral are now endangered species."
            $(text).removeClass().addClass("bodyC");
            $(".secondMessage").css("display", "none");
        ...
        setTimeout(function () {
            $(text).html("<span class='titleTwo'>We can make a difference!</span><br>By reducing our dependency on fossil fuels, oil, plastics, and by switching to cleaner and more environmentally conscious sources of fuel we can save our ocean!<br><br>By just recycling, switching to re-useable containers, carpooling, and/or taking alternative forms of travel; we can reduce our planet’s dependency on fossil fuels and oil and further preventing spills in our ocean.<br><a href='Sources.txt' target='_blank'>Sources</a>");
            $(text).removeClass().addClass("bodyC");
            $(".secondMessage").css("display", "none")
        }, 800);
        fixRot();
